...
## Next Move
1. Continue `World.java` decomposition: **Stage 6 — `Explosion`** (keep `WorldServer` `newExplosion`/`newBlockExplosion` factory hooks). (Stages 1-5 complete; SaveConverterMcRegion constructor fix pending user test of block ticks in game.)
