...
## Next Move
1. Continue **`net.minecraft.client.gui` package cleanup**: process `GuiButton.java`, `GuiTextField.java`, `GuiSlider.java`, `GuiIngame.java`, `GuiIngameMenu.java`, `GuiMainMenu.java`, and all remaining GUI files (256-height implementation and its post-implementation lighting/`LightVersion` fixes are complete — see Completed).
