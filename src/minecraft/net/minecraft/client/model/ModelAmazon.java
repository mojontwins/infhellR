...
public class ModelAmazon extends ModelBase {
	...
	public ModelAmazon(float defaultScale) {
		this(defaultScale, 0.0F);
	}

	public ModelAmazon(float defaultScale, float headYOffset) {
	...
	public void setLivingAnimations(EntityLiving entity, float limbSwing, float limbSwingAmount, float partialTick) {
		EntityAmazon amazon = (EntityAmazon)entity;

		if(amazon.getIsSitting()) {
		...
		this.bipedHead.rotateAngleX = amazon.getInterestedAngle(partialTick);
	}
