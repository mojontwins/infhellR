...
public class RenderIceBall extends Render {
	...
	public void doRenderIceBall(EntityIceBall iceBall, double x, double y, double z, float yaw, float partialTicks) {
		GL11.glPushMatrix();
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float partialTicks) {
		this.doRenderIceBall((EntityIceBall)entity, x, y, z, yaw, partialTicks);
	}
