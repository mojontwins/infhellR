...
public class EntityPigman extends EntityTrader {
	private int randomSoundDelay = 0;
	
	public EntityPigman(World world1) {
		super(world1);
	...
	public void onUpdate() {
		...
		if(this.randomSoundDelay > 0 && --this.randomSoundDelay == 0) {
			this.worldObj.playSoundAtEntity(this, "mob.pig", this.getSoundVolume() * 2.0F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F) * 1.8F);
		}
	...
	public boolean attackEntityFrom(Entity entity, int i2) {
		if(entity instanceof EntityPigman) return false;
		...
		if(entity instanceof EntityPlayer || entity instanceof EntityZombie) {
			...
			for(int i5 = 0; i5 < list4.size(); ++i5) {
				...
				if(entity6 instanceof EntityPigman) {
					EntityPigman entityPigman7 = (EntityPigman)entity6;
					entityPigman7.becomeAngryAt(entity);
				}
			}
