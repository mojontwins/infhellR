...
public class EntityFallingSand extends Entity {
	...
	public void onUpdate() {
		if(this.blockID == 0) {
			...
			if(this.blockID == Block.cementPowder.blockID) {
				if(this.worldObj.getBlockMaterial(i1, i2, i3) == Material.water) {
					this.worldObj.setBlockWithNotify(i1, i2, i3, Block.cement.blockID);
				}
			}
