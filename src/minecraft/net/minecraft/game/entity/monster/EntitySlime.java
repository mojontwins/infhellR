...
public class EntitySlime extends EntityLiving implements IMob {
	...
	protected void entityInit() {
		super.entityInit();
		this.dataWatcher.addObject(Datawatchers.DW_STATUS, new Byte((byte)1));
	}

	public void setSlimeSize(int i1) {
		this.dataWatcher.updateObject(Datawatchers.DW_STATUS, new Byte((byte)i1));
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && chunk1.getRandomWithSeed(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
