...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		*/
		...
		// Softlocked for b1.2
		this.addRecipe(new ItemStack(Item.bed, 1), new Object[]{"###", "XXX", '#', Block.cloth, 'X', Block.planks}).setEnabled(false);;
	...
	public static IRecipe findFirstRecipeToMake (int shiftedIndex) {
		CraftingManager cm = CraftingManager.getInstance ();
		for(IRecipe recipe : cm.recipes) {
			if(recipe.getRecipeOutput().getItem().shiftedIndex == shiftedIndex) return recipe;
		}
		
		return null;
	}

	IRecipe addRecipe(ItemStack itemStack1, Object... object2) {
		String string3 = "";
		int i4 = 0;
		int i5 = 0;
		int i6 = 0;
		...
		IRecipe recipe = new ShapedRecipes(i5, i6, itemStack14, itemStack1);
		this.recipes.add(recipe);
		return recipe;
	}

	IRecipe addShapelessRecipe(ItemStack itemStack1, Object... object2) {
		...
		IRecipe recipe = new ShapelessRecipes(itemStack1, arrayList3);
