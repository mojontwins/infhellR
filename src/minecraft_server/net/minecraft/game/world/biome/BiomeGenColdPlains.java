...
public class BiomeGenColdPlains extends BiomeGenPlains {
	public BiomeGenColdPlains() {
		super();
		...
		this.spawnableCreatureList.add(new SpawnListEntry(EntityPig.class, 2));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityGoat.class, 2));
