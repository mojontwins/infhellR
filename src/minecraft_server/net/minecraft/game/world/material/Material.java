...
public class Material {
	...
	public static final Material sponge = new MaterialLayered(MapColor.clothColor);
	...
	public static final Material layeredSand = (new MaterialLogic(MapColor.sandColor)).setName("layeredSand").setIsGroundCover();
	...
	public static final Material vine = (new MaterialLogic(MapColor.grassColor)).setBurning().setIsGroundCover();
	public static final Material bone = (new Material(MapColor.iceColor));
	public static final Material spawner = (new Material(MapColor.clayColor)).setName("spawner");
